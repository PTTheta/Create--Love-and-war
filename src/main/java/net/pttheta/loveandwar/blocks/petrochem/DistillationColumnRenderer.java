...
public class DistillationColumnRenderer extends SafeBlockEntityRenderer<DistillationColumnBlockEntity> {

    public DistillationColumnRenderer(BlockEntityRendererProvider.Context context) {
    }

    @Override
    protected void renderSafe(DistillationColumnBlockEntity be, float partialTicks, PoseStack ms, MultiBufferSource buffer,
    ...
    protected void renderAsBoiler(DistillationColumnBlockEntity be, float partialTicks, PoseStack ms, MultiBufferSource buffer,
                                  int light, int overlay) {
        ...
        for (Direction d : Iterate.horizontalDirections) {
            ms.pushPose();
            CachedBufferer.partial(LAWPartialModels.DISTILLATION_GAUGE, blockState)
                    .rotateY(d.toYRot())
                    .unCentre()
