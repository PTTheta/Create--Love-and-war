...
public class DrawingBehaviour extends BeltProcessingBehaviour {
    ...
    public interface DrawingBehaviourSpecifics {
    ...
    public <T extends SmartBlockEntity & DrawingBehaviourSpecifics> DrawingBehaviour(T be) {
        super(be);
        this.specifics = be;
        mode = Mode.WORLD;
        entityScanCooldown = ENTITY_SCAN;
        whenItemEnters((s, i) -> BeltDrawingCallbacks.onItemReceived(s, i, this));
        whileItemHeld((s, i) -> BeltDrawingCallbacks.whenItemHeld(s, i, this));
    }

    @Override
    public void read(CompoundTag compound, boolean clientPacket) {
        running = compound.getBoolean("Running");
        mode = DrawingBehaviour.Mode.values()[compound.getInt("Mode")];
