...
public class StampingBehaviour extends BeltProcessingBehaviour {
    ...
    public interface StampingBehaviourSpecifics {
    ...
    public <T extends SmartBlockEntity & StampingBehaviourSpecifics> StampingBehaviour(T be) {
        super(be);
        this.specifics = be;
        mode = Mode.WORLD;
