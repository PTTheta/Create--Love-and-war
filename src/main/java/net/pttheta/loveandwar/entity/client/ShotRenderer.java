...
public class ShotRenderer <T extends ShotProjectile> extends EntityRenderer<T> {

    public ShotRenderer(EntityRendererProvider.Context pContext) {
        super(pContext);
    }
    ...
    public ResourceLocation getTextureLocation(T pEntity) {
        return new ResourceLocation(LoveAndWarMod.MODID, "textures/entity/shot.png");
    }
}
