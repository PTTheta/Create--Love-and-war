...
public class AnimatedDrawingPress extends AnimatedKinetics {

	private boolean basin;

	public AnimatedDrawingPress(boolean basin) {
		this.basin = false;
	}
	...
	public void draw(GuiGraphics graphics, int xOffset, int yOffset) {
		...
		blockElement(LAWBlocks.DRAWING_PRESS.getDefaultState())
				.scale(scale)
				.render(graphics);

		blockElement(LAWPartialModels.DRAWING_PRESS_HEAD)
