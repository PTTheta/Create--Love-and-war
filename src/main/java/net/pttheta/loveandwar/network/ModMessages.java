...
public class ModMessages {
    ...
    public static void register() {
        SimpleChannel net = NetworkRegistry.ChannelBuilder
                .named(new ResourceLocation(LoveAndWarMod.MODID, "messages"))
        ...
        net.messageBuilder(SSendMessage.class, id(), NetworkDirection.PLAY_TO_SERVER)
    ...
    public static <MSG> void sendToNearbyPlayers(MSG message, PacketDistributor.TargetPoint point){
